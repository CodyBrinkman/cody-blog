  ...
  return (
    <div style={{paddingLeft: 10}}>
      ...
      <div style={{fontSize: 18}}>
        ...
        <ul>
          <li>Teach myself full stack webd design</li>
        ...
        is designed and coded by me. I am starting off using React hosted by an Apache webserver, but hope to containerize
        the code and serve it using Kubernetes in the future. Things look bare now, but I promise the content will be worth
        your time!
        <br />
        <br />
