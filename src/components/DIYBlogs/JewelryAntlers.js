    ...
    <>
      <div style={{paddingLeft: 10, paddingRight: 10}}>
        ...
        <div style={{fontSize: 22}}>
          ...
          <br />
          <br />
          I wish I could give some great wisdom here about getting this right every time, but it was truly just trial and error. I strayed from the video slightly here. In the video they lay the full Leather and trim it while gluing. Leather is somewhat pricey so to minimize needing to buy another piece I first got an old pair of jeans and used that to make a template. The difficulty will depend on the shape of your base and antlers. For mine, we first used a sharpie to mark around the base of the antlers. I then cut a line from the edge to the base of each antler and continued to trim around to get it as snug around the pedicle as possible. Mine was going against a wall so my main objective was to ensure the front looked good and I was able to put all the seams on the back. Your mileage may vary though. If it takes some time, don't worry. Go for a walk to clear your mind and keep working at it. It took my dad and I 3 tries to get it how we wanted. Once you get your golden template, trace it onto the leather and cut it out as accurately as you can. Dry fitting it to ensure it's exactly as you like, you're ready for the real thing!
          <Image name='leatherwrapping1' caption='Figure 6: Leather template'/>
          <br />
          ...
          <Image name='leatherwrapping2' caption='Figure 7: gluing the leather'/>
          <br />
          ...
          <Image name='leatherwrappingfinal' caption='Figure 8: Leather wrapping outcome'/>
          <br />
          <h3>6. Building the box</h3>
          For me making it to this step was a huge relief. All of the antler mounting was new to me, but working with wood is a lot more familiar. My plan was to have necklaces, bracelets, and rings hang on the branch, but I still needed a place for earrings and other miscellaneous items. My solution was just to frame a box and line it with a soft material. I encourage you to get creative here!
          <br />
          <br />
          ...
          <Image name='framingbox' caption='Figure 9: Building the box frame'/>
          <br />
